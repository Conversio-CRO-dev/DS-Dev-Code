// console.log("David Silva | WN009 variation 1");
    ...
    waitForDataLayer(() => {
      window.dataLayer.push({
        ...
        conversio: {
          ...
          experience_label: "WN009 | Variation 1",
          experience_segment: "WN009.XV1",
        },
      });
    });
  }
        ...
        if (entry.isIntersecting) {
          ...
          window.dataLayer.push({
            ...
            conversio: {
              ...
              event_label: "WN009 | (Variation 1) | Break Card Impression",
              event_segment: "WN009EV1H",
            },
          });
    ...
    if (path.indexOf("/hotels/") === 0 && path !== lastHubPath) {
      ...
      window.dataLayer.push({
        ...
        conversio: {
          ...
          event_action: "WN009 | Event Tracking",
          event_label:
            "WN009 | (Variation 1) | User lands on a Hotel Location Hub Page",
          event_segment: "WN009EV1K",
        },
      });
    ...
    if (path.indexOf("/breaks/") === 0 && path !== lastBreaksPath) {
      ...
      window.dataLayer.push({
        ...
        conversio: {
          ...
          event_action: "WN009 | Event Tracking",
          event_label:
            "WN009 | (Variation 1) | User lands on a Hotel Breaks Card Page",
          event_segment: "WN009EV1L",
        },
      });
        ...
        if (e.target.closest(".breakDetailItemCta")) {
          ...
          window.dataLayer.push({
            ...
            conversio: {
              event_category: "Conversio CRO",
              event_action: "WN009 | Event Tracking",
              event_label: "WN009 | (Variation 1) | Break Card CTA Click",
              event_segment: "WN009EV1G",
            },
          });
        ...
        if (e.target.closest(".pageHeaderCta--book")) {
          ...
          window.dataLayer.push({
            ...
            conversio: {
              event_category: "Conversio CRO",
              event_action: "WN009 | Event Tracking",
              event_label: "WN009 | (Variation 1) | Header BOOK CTA Click",
              event_segment: "WN009EV1I",
            },
          });
        ...
        if (e.target.closest(".carouselButton")) {
          ...
          window.dataLayer.push({
            ...
            conversio: {
              ...
              event_action: "WN009 | Event Tracking",
              event_label:
                "WN009 | (Variation 1) | Break Image Carousel Arrow Click",
              event_segment: "WN009EV1J",
            },
          });
