// console.log("David Silva | TS036 variation 1");
  ...
  const PRODUCTS = [
    {
      ...
      newText: "Kids and Family Fun Experience | Starter Track",
    },
    {
      match: "rookie racer 342 | starter track",
      newText: "Kids and Family Fun 342 | Starter Track",
    },
  ];
  let applying = false;
...
function keepBookingPageUpdated() {
  ...
  const NEW_TEXT_NAME = "Kids and Family Fun Experience | Starter Track";
  const NEW_SRC =
    "https://images.prismic.io/teamsport/Zwzfr4F3NbkBXY0g_TeamsportE-KartingGermany-19th%2620thAugust2022-294.png";
  ...
  const NEW_TEXT_NAME_342 = "Kids and Family Fun 342 | Starter Track";
  ...
  function check() {
    ...
    const experiencePresent = h3s.some((h3) =>
      h3.textContent
        .trim()
        .toLowerCase()
        .includes("kids and family fun experience | starter track"),
    );
    const the342Present = h3s.some((h3) =>
      h3.textContent
        .trim()
        .toLowerCase()
        .includes("kids and family fun 342 | starter track"),
    );
    const nowPresent = experiencePresent || the342Present;
    if (nowPresent && !present) {
      /* Event snippet — segment: TS036EV1G */
      window.dataLayer.push({
        ...
        conversio: {
          ...
          eventLabel:
            "TS036 | (Variation 1) | Search Results Page With Rookie Race/ Kids & Family Experience Viewed",
          eventSegment: "TS036EV1G",
        },
      });

      // if (experiencePresent) console.log("Kids and Family Fun Experience | Starter Track Viewed");
      // if (the342Present) console.log("Kids and Family Fun 342 | Starter Track Viewed");
    }
    present = nowPresent;
  }
  ...
  function check() {
    ...
    for (const list of lists) {
      ...
      if (
        ...
        tracked = true;
        /* Event snippet — segment: TS036EV1J */
        window.dataLayer.push({
          event: "conversioEvent",
          conversio: {
            eventCategory: "Conversio CRO",
            eventAction: "TS036 | Event Tracking",
            eventLabel:
              "TS036 | (Variation 1) | BMI Rookie Race/Kids & Family Time Slot Selector Appears",
            eventSegment: "TS036EV1J",
          },
        });
...
function trackAddedToCartOverlayAppears() {
  ...
  function check() {
    ...
    if (nowPresent && !present) {
      /* Event snippet — segment: TS036EV1K */
      window.dataLayer.push({
        event: "conversioEvent",
        conversio: {
          eventCategory: "Conversio CRO",
          eventAction: "TS036 | Event Tracking",
          eventLabel:
            "TS036 | (Variation 1) | BMI Rookie Race/Kids & Family Added to cart overlay appears",
          eventSegment: "TS036EV1K",
        },
      });
    ...
    document.addEventListener("click", (e) => {
      ...
      if (timeSlotBtn) {
        ...
        if (
          ...
          h3Text &&
          (h3Text.includes("kids and family fun experience | starter track") ||
            h3Text.includes("kids and family fun 342 | starter track"))
        ) {
          /* Event snippet — segment: TS036EV1H */
          window.dataLayer.push({
            event: "conversioEvent",
            conversio: {
              eventCategory: "Conversio CRO",
              eventAction: "TS036 | Event Tracking",
              eventLabel:
                "TS036 | (Variation 1) | Rookie Race/Kids & Family Time Slot Click",
              eventSegment: "TS036EV1H",
            },
          });
      ...
      if (
        ...
        if (
          bookNowH3Text &&
          (bookNowH3Text.includes(
            "kids and family fun experience | starter track",
          ) ||
            bookNowH3Text.includes("kids and family fun 342 | starter track"))
        ) {
          /* Event snippet — segment: TS036EV1I */
          window.dataLayer.push({
            event: "conversioEvent",
            conversio: {
              eventCategory: "Conversio CRO",
              eventAction: "TS036 | Event Tracking",
              eventLabel:
                "TS036 | (Variation 1) | Rookie Race/Kids & Family BOOK NOW Click",
              eventSegment: "TS036EV1I",
            },
          });
      ...
      if (window.location.hostname.includes("booking.sms-timing.com")) {
        ...
        if (bookNowIonBtn) {
          ...
          if (
            ...
            /* Event snippet — segment: TS036EV1L */
            window.dataLayer.push({
              event: "conversioEvent",
              conversio: {
                eventCategory: "Conversio CRO",
                eventAction: "TS036 | Event Tracking",
                eventLabel:
                  "TS036 | (Variation 1) | BMI Rookie Race/Kids & Family Time Slot Window BOOK NOW Click",
                eventSegment: "TS036EV1L",
              },
            });
      ...
      if (window.location.hostname.includes("booking.sms-timing.com")) {
        ...
        if (checkoutBtn) {
          ...
          if (
            ...
            /* Event snippet — segment: TS036EV1M */
            window.dataLayer.push({
              event: "conversioEvent",
              conversio: {
                eventCategory: "Conversio CRO",
                eventAction: "TS036 | Event Tracking",
                eventLabel:
                  "TS036 | (Variation 1) | BMI Rookie Race/Kids & Family PROCEED TO CHECKOUT Click",
                eventSegment: "TS036EV1M",
              },
            });
      ...
      if (window.location.hostname.includes("booking.sms-timing.com")) {
        ...
        if (continueBtn) {
          ...
          if (
            ...
            /* Event snippet — segment: TS036EV1N */
            window.dataLayer.push({
              event: "conversioEvent",
              conversio: {
                eventCategory: "Conversio CRO",
                eventAction: "TS036 | Event Tracking",
                eventLabel:
                  "TS036 | (Variation 1) | BMI Rookie Race/Kids & Family CONTINUE SHOPPING Click",
                eventSegment: "TS036EV1N",
              },
            });
