// console.log("David Silva | FN097 variation 2");
        ...
        if (e.target.closest(".boxes a")) {
          window.dataLayer.push({
            ...
            conversio: {
              ...
              eventLabel: "FN097 | (Variation 2) | Selects colour",
              eventSegment: "FN097EV2G",
            },
          });
        ...
        if (e.target.closest("[data-size-guide-trigger]")) {
          window.dataLayer.push({
            ...
            conversio: {
              eventCategory: "Conversio CRO",
              eventAction: "FN097 | Event Tracking",
              eventLabel: "FN097 | (Variation 2) | Clicks find your size",
              eventSegment: "FN097EV2H",
            },
          });
        ...
        if (
          ...
          window.dataLayer.push({
            ...
            conversio: {
              ...
              eventAction: "FN097 | Event Tracking",
              eventLabel:
                "FN097 | (Variation 2) | Opens size selector dropdown",
              eventSegment: "FN097EV2I",
            },
          });
        ...
        if (
          ...
          window.dataLayer.push({
            ...
            conversio: {
              eventCategory: "Conversio CRO",
              eventAction: "FN097 | Event Tracking",
              eventLabel: "FN097 | (Variation 2) | Selects size from dropdown",
              eventSegment: "FN097EV2J",
            },
          });
        ...
        if (
          ...
          window.dataLayer.push({
            ...
            conversio: {
              eventCategory: "Conversio CRO",
              eventAction: "FN097 | Event Tracking",
              eventLabel: "FN097 | (Variation 2) | Clicks Reviews Summary",
              eventSegment: "FN097EV2K",
            },
          });
        ...
        if (
          ...
          window.dataLayer.push({
            ...
            conversio: {
              ...
              eventAction: "FN097 | Event Tracking",
              eventLabel:
                "FN097 | (Variation 2) | Opens product info dropdown | " +
                titleText,
              eventSegment: "FN097EV2L",
            },
          });
