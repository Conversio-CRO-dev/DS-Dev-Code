...
elementReady("body").then((main) => {
  if (!main.classList.contains("test-lt153")) {
    main.addEventListener("click", (e) => {
      ...
      const nextBtn = e.target.closest(".ais-Pagination-item--nextPage button");
      const pageLink = e.target.closest('[data-testid^="pagination-link-"]');
        ...
        adobeDataLayer.push({
          ...
          eventData: {
            click: {
              clickLocation: "Conversio CRO",
              clickAction: "LT153 | Event Tracking",
              clickText: "LT153 (Variation 1) | Pagination click - Next page",
            },
          },
        });
      } else if (pageLink) {
        ...
        adobeDataLayer.push({
          ...
          eventData: {
            click: {
              ...
              clickAction: "LT153 | Event Tracking",
              clickText:
                "LT153 (Variation 1) | Pagination click - Page " + pageNumber,
            },
          },
        });
      }
            ...
            adobeDataLayer.push({
              ...
              eventData: {
                click: {
                  clickLocation: "Conversio CRO",
                  clickAction: "LT153 | Event Tracking",
                  clickText: "LT153 (Variation 1) | Scroll depth reached 25%",
                },
              },
            });
          }
            ...
            adobeDataLayer.push({
              ...
              eventData: {
                click: {
                  clickLocation: "Conversio CRO",
                  clickAction: "LT153 | Event Tracking",
                  clickText: "LT153 (Variation 1) | Scroll depth reached 50%",
                },
              },
            });
          }
            ...
            adobeDataLayer.push({
              ...
              eventData: {
                click: {
                  clickLocation: "Conversio CRO",
                  clickAction: "LT153 | Event Tracking",
                  clickText: "LT153 (Variation 1) | Scroll depth reached 75%",
                },
              },
            });
          }
